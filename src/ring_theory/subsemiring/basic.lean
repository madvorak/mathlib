...
class subsemiring_class (S : Type*) (R : out_param $ Type u) [non_assoc_semiring R]
...
instance subsemiring_class.add_submonoid_class (S : Type*) (R : out_param $ Type u)
  [non_assoc_semiring R] [h : subsemiring_class S R] :
  add_submonoid_class S R :=
{ .. h }

variables [non_assoc_semiring R] [hSR : subsemiring_class S R] (s : S)
include hSR
...
instance to_semiring {R} [semiring R] [subsemiring_class S R] : semiring s :=
{ ..subsemiring_class.to_non_assoc_semiring s,
  ..submonoid_class.to_monoid s }

@[simp, norm_cast] lemma coe_pow {R} [semiring R] [subsemiring_class S R] (x : s) (n : ℕ) :
  ((x^n : s) : R) = (x^n : R) :=
begin
...
instance to_comm_semiring {R} [comm_semiring R] [subsemiring_class S R] : comm_semiring s :=
...
instance to_ordered_semiring {R} [ordered_semiring R] [subsemiring_class S R] :
  ordered_semiring s :=
...
instance to_ordered_comm_semiring {R} [ordered_comm_semiring R] [subsemiring_class S R] :
...
instance to_linear_ordered_semiring {R} [linear_ordered_semiring R] [subsemiring_class S R] :
