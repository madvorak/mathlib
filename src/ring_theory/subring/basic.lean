...
class subring_class (S : Type*) (R : out_param $ Type u) [ring R]
  extends subsemiring_class S R :=
(neg_mem : ∀ {s : S} {a : R}, a ∈ s → -a ∈ s)

instance subring_class.add_subgroup_class (S : Type*) (R : out_param $ Type u)
  [ring R] [h : subring_class S R] : add_subgroup_class S R :=
{ .. h }

variables [hSR : subring_class S R] (s : S)
include hSR
...
instance to_comm_ring {R} [comm_ring R] [subring_class S R] : comm_ring s :=
{ mul_comm := λ _ _, subtype.eq $ mul_comm _ _, .. subring_class.to_ring s}

/-- A subring of a domain is a domain. -/
instance {R} [ring R] [is_domain R] [subring_class S R] : is_domain s :=
{ .. subsemiring_class.nontrivial s, .. subsemiring_class.no_zero_divisors s }

/-- A subring of an `ordered_ring` is an `ordered_ring`. -/
instance to_ordered_ring {R} [ordered_ring R] [subring_class S R] : ordered_ring s :=
...
instance to_ordered_comm_ring {R} [ordered_comm_ring R] [subring_class S R] : ordered_comm_ring s :=
...
instance to_linear_ordered_ring {R} [linear_ordered_ring R] [subring_class S R] :
...
instance to_linear_ordered_comm_ring {R} [linear_ordered_comm_ring R] [subring_class S R] :
