...
class zero_mem_class (S : Type*) (M : out_param $ Type*) [has_zero M]
  extends set_like S M :=
(zero_mem : ∀ (s : S), (0 : M) ∈ s)
...
class mul_mem_class (S : Type*) (M : out_param $ Type*) [has_mul M]
  extends set_like S M :=
...
class add_mem_class (S : Type*) (M : out_param $ Type*) [has_add M]
  extends set_like S M :=
...
class submonoid_class (S : Type*) (M : out_param $ Type*) [mul_one_class M]
...
class add_submonoid_class (S : Type*) (M : out_param $ Type*) [add_zero_class M]
...
instance submonoid_class.to_one_mem_class (S : Type*) (M : out_param $ Type*) [mul_one_class M]
  [h : submonoid_class S M] : one_mem_class S M := { ..h }
